...
|---------|-------|
| **Ch0** | Setting Up Your Python Environment *(GitHub only)* |
| **Ch1** | Reading Time Series Data from Files |
| **Ch2** | Reading Time Series Data from Databases |
| **Ch3** | Persisting Time Series Data to Files |
| **Ch4** | Persisting Time Series Data to Databases |
| **Ch5** | Working with Date and Time in Python |
| **Ch6** | Handling Missing Data |
| **Ch7** | Outlier Detection Using Statistical Methods |
| **Ch8** | Exploratory Data Analysis and Diagnosis |
